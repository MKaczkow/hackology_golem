...
mock_sales_data = Tool(
    name="mock_sales_data",
    description="gets digeastable sales insights based on location and product id, both location and product ids are intigers",
    func=mock_sales_data_fun,
)

def mock_sales_data_fun(location_id, product_id):
    """
...
def mock_competitive_analysis(location_id, product_id):
    """
        gets digeastable information about competitors insights based on location and product id, both location and product ids are intigers
    """
    return {
        "1": {
            "1": [
